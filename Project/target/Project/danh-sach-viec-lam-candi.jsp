            ...
            <div class="container">
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  <div class="company-img">
                    <a href="thong-tin-viec-lam.html"><img src="assets/img/icon/job-list1.png" alt=""></a>
                  </div>
                  <div class="job-tittle job-tittle2">
                    <a href="thong-tin-viec-lam.html">
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  ...
                  <div class="job-tittle job-tittle2">
                    <a href="thong-tin-viec-lam.html">
                      <h4>Chuyên viên tư vấn mảng tuyển dụng</h4>
                    </a>
                    <ul>
                ...
                <div class="job-items">
                  ...
                  <div class="job-tittle job-tittle2">
                    ...
                    <ul>
                      ...
                      <li><i class="fas fa-map-marker-alt"></i>Sơn Tây, Hà Nội</li>
                      <li>8 - 10tr VNĐ</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  ...
                  <div class="job-tittle job-tittle2">
                    <a href="#">
                      <h4>Nhà phát triển trò chơi Unity - Mọi cấp độ</h4>
                    </a>
                    <ul>
                      <li>BBOLD JSC</li>
                      <li><i class="fas fa-map-marker-alt"></i>Q. Tân Bình, HCM</li>
                      <li>15 - 20tr VNĐ</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  ...
                  <div class="job-tittle job-tittle2">
                    <a href="#">
                      <h4>Nhân Viên Lập Trình .Net Developer</h4>
                    </a>
                    <ul>
                      <li>Cty phát triển phần mền Việt</li>
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  ...
                  <div class="job-tittle job-tittle2">
                    ...
                    <ul>
                      <li>CTY thương mại và giải trí</li>
                      <li><i class="fas fa-map-marker-alt"></i>Q2, HCM</li>
                      <li>20-22tr VNĐ</li>
                    </ul>
                  </div>
